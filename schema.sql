...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`FK_UserID`) REFERENCES `user` (`ID`),
  CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`MovieID`) REFERENCES `movie` (`ID`),
  CONSTRAINT `comments_ibfk_3` FOREIGN KEY (`FK_UserID`) REFERENCES `user` (`ID`)
